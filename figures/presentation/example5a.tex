...
%	\shade[ball color=magenta!80!white] (\xoffset - 2.2 ,\yoffset+1,-1) circle (0.225);
	...
	\path[align=center] (4.24,\side+0.33,-1) node [align=center, anchor=south] {\textsf{reply(}\texttt{PRIORITY},$\langle$\taskball{magenta}{0.175},\textsf{high}$\rangle$\textsf{)}};	
	
	\path[draw, ->, line width=1pt, rounded corners=6pt] (0.67,\side,-1) -- ++(0,1.5,0)  -|  (6,7.5,-1);
	\path[align=center] (3.5,\side+1.5,-1) node [align=center, anchor=south] {\textsf{request(}\texttt{PRIORITY},$\langle$\taskball{magenta}{0.175}$\rangle$\textsf{)}};	
	
	
	\path[draw, ->, line width=1pt, rounded corners=6pt] (4.5,8,-1) -- ++(0,-1.75,0)  -|  (-3.165,5,-1);
	\path[align=center] (0,6.25,-1) node [align=center, anchor=north] {\textsf{request(}\texttt{PRIORITY},$\langle$\taskball{magenta}{0.175}$\rangle$\textsf{)}};	
	
	\path[draw, ->, line width=1pt, rounded corners=6pt] (-3.835,5,-1) -- ++(0,1.75,0)  -|  (3.5,7.5,-1);
	\path[align=center] (0,6.75,-1) node [align=center, anchor=south] {\textsf{reply(}\texttt{PRIORITY},$\langle$\taskball{magenta}{0.175},\textsf{high}$\rangle$\textsf{)}};	
