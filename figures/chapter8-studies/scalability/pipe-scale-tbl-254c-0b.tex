\begin{table}
	...
	\centering
	\caption[Scalability experiment results with 254~PEs and \SI{0}{\micro\second} Workload.]{Scalability experiment results with 254~PEs and \SI{0}{\micro\second} Workload. The mean runtimes and confidence intervals are given in microseconds (\cf~\cref{sec:studies:scale:results}).}
	\label{tbl:scale:254c0p}
	{\tiny
	...
	]{figures/chapter8-studies/scalability/data/m5out-254c-0b.dat}}\vspace{0.33cm}
	{\tiny
	\pgfplotstabletypeset[
		col sep=comma,
		...
		every last row/.style={after row=\bottomrule},
	]{figures/chapter8-studies/scalability/data/m5out-254c-0b.dat}}
\end{table}
