\begin{table}
	...
	\centering
	\caption[Scalability experiment results with 16~PEs and \SI{500}{\micro\second} Workload.]{Scalability experiment results with 16~PEs and \SI{500}{\micro\second} Workload. The mean runtimes and confidence intervals are given in microseconds (\cf~\cref{sec:studies:scale:results}).}
	\label{tbl:scale:16c500p}
	{\tiny
	...
	]{figures/chapter8-studies/scalability/data/m5out-16c-500b.dat}}\vspace{0.33cm}
	{\tiny
	\pgfplotstabletypeset[
		col sep=comma,
		...
		every last row/.style={after row=\bottomrule},
	]{figures/chapter8-studies/scalability/data/m5out-16c-500b.dat}}
\end{table}
