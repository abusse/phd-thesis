\begin{scaletikzpicturetowidth}{0.925\textwidth}
	\begin{tikzpicture}[scale=\tikzscale, every node/.style={transform shape,font=\sf}]
		\colorlet{NewCPU}{orange!30}
		\colorlet{DSP}{yellow!30}
		\colorlet{FGPA}{red!30}
		\colorlet{Neural}{yellow!30}
		\colorlet{Graph}{yellow!30}
		\colorlet{NoCBridge}{blue!30}
		\colorlet{Hub}{blue!30}
		...
		\draw[fill=FGPA]   (8,-4) rectangle ++(3,3) node[pos=0.5] {\large \breakC{Reconfigurable\\Computing\\Resource\\(FPGA)}};
		\draw (9.5,-1) -- ++(0,1);
