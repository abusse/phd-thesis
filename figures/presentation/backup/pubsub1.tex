...
\begin{tikzpicture}[scale=\tikzscale, every node/.style={transform shape}]\sf
	...
	\shade[ball color=red!80!white]  (\xoffset - 0.0 ,\yoffset+1,-1) circle (0.225);
	...
	\path[draw, <-, line width=1pt, rounded corners=6pt] (\side+7.5+1,\side+2.2,-1) -- ++(0,2,0)  -|  (6.5,8,-1);
	\path[align=center] (7,\side+2.2+2,-1) node [align=center, anchor=south west] {\textsf{notify(}\texttt{PRIORITY},$\langle$\taskball{red}{0.175},\textsf{high}$\rangle$\textsf{)}};	
	
	\path[draw, <-, line width=1pt, rounded corners=6pt] (-3.5,5,-1) -- ++(0,1.5,0)  -| (4.5,8,-1);
	\path[align=center] (0.5,6.5,-1) node [align=center, anchor=south] {\textsf{notify(}\texttt{PRIORITY},$\langle$\taskball{red}{0.175},\textsf{high}$\rangle$\textsf{)}};	
	...
	\path[align=center] (-0.5,10,-1) node [align=center, anchor=south] {\textsf{notify(}\texttt{PRIORITY},$\langle$\taskball{red}{0.175},\textsf{high}$\rangle$\textsf{)}};	
