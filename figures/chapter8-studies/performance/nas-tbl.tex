\begin{table}[h!]
	...
	\centering
	\caption[Performance evaluation results for the NAS benchmark suite.]{Performance evaluation results for the NAS benchmark suite. The mean runtimes and confidence intervals are given in seconds. Each benchmark was repeated \num{50} times (\cf~\cref{sec:studies:nas:results}).}
	\label{tbl:performance:nas}\vspace{-2.5mm}

	{\small
	\pgfplotstabletypeset[
		col sep=comma,
	    columns={label,cobas, Ecobas, cfs, Ecfs, ratio},
		columns/label/.style		= {column type=c,  column name=, string type},
		...
		every head row/.style={
		    before row={
		        \toprule
		        \multicolumn{1}{c}{\multirow{2}{*}{\raisebox{-7.5pt}{\breakC{NAS\\Bechmark}}}}
	...
	]{figures/chapter8-studies/performance/results.dat}
	}
\end{table}
