...
\begin{tikzpicture}[scale=\tikzscale, every node/.style={transform shape}]
	...
	\path[draw, ->, line width=1pt, rounded corners=6pt] (\side+\xoffset+0.5,\yoffset+1.5,-1) -- node [align=center, anchor=south] {\circled{$3$} \textsf{update\_pipe()}} ++(4,0,0) ;
...
%	\shade[ball color=orange!40!white, draw, densely dotted] (\xoffset - 4.0 ,\yoffset+1,-1) circle (0.225);
...
%	\shade[ball color=orange!40!white, draw, densely dotted] (\xoffset - 2.2 ,\yoffset+1,-1) circle (0.225);
	...
	\path[draw, ->, line width=1pt, rounded corners=6pt] (\side+0.5,\yoffset+0.5,-1) -- node [align=center, anchor=north] {\circled{$8$} \textsf{update\_pipe()}} ++(3,0,0) ;
	
	\path[draw, ->, line width=1pt, rounded corners=6pt] (\side+\xoffset+0.5,\yoffset+0.5,-1) -- node [align=center, anchor=north] {\circled{$9$} \textsf{update\_pipe()}} ++(3,0,0) ;
...
%	\shade[ball color=orange!40!white, draw, densely dotted] (\xoffset - 2.2 ,\yoffset+1,-1) circle (0.225);
	...
	\path[align=center] (4.24,\side+0.33,-1) node [align=center, anchor=south] {\circled{$7$} \textsf{reply(}\texttt{AFFINITY},$\langle$\taskball{orange}{0.175},\textsf{1\&2}$\rangle$\textsf{)}};	
	
	\path[draw, ->, line width=1pt, rounded corners=6pt] (0.67,\side,-1) -- ++(0,1.5,0)  -|  (6,7.5,-1);
	\path[align=center] (3.5,\side+1.5,-1) node [align=center, anchor=south] {\circled{$4$} \textsf{request(}\texttt{AFFINITY},$\langle$\taskball{orange}{0.175}$\rangle$\textsf{)}};	
	
	
	\path[draw, ->, line width=1pt, rounded corners=6pt] (4.5,8,-1) -- ++(0,-1.75,0)  -|  (0.33,5,-1);
	\path[align=center] (2.75,6.25,-1) node [align=center, anchor=north] {\circled{$5$} \textsf{request(}\texttt{AFFINITY},$\langle$\taskball{orange}{0.175}$\rangle$\textsf{)}};	
	
	\path[draw, ->, line width=1pt, rounded corners=6pt] (-0.33,5,-1) -- ++(0,1.75,0)  -|  (3.5,7.5,-1);
	\path[align=center] (1,6.75,-1) node [align=center, anchor=south] {\circled{$6$} \textsf{reply(}\texttt{AFFINITY},$\langle$\taskball{orange}{0.175},\textsf{1\&2}$\rangle$\textsf{)}};	
	...
	\path[align=center] (-0.5,10.5,-1) node [align=center, anchor=south] {\circled{$1$} \textsf{notify(}\texttt{ADMIT},$\langle$\taskball{orange}{0.175}$\rangle$\textsf{)}};
	
	\path[draw, <-, line width=1pt, rounded corners=6pt] (-5.5,10,-1) -| (5,9,-1);
	\path[align=center] (-0.5,10,-1) node [align=center, anchor=north] {\circled{$2$} \textsf{notify(}\texttt{ADMIT},$\langle$\taskball{orange}{0.175}$\rangle$\textsf{)}};
